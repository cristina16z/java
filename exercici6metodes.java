                                                            ...
                                                            //public int countYZ(String str) {
                                                                ...
                                                                for(int i = 0; i<len-1;i++) {
                                                                    ...
                                                                    if (!Character.isLetter(carSeguent)) {
                                                                        ...
                                                                        if (car == 'y' || car == 'z' || car == 'Y' || car == 'Z') {
                                                                            countYZ++;
                                                                        }
                                                                    }
                                                                }
                                                                        
                                                                //ultima lletra es y o z?
                                                                ...
                                                                "hello there", "e" --> "hllo thr"       */
                                                                    ...
                                                                    public String withoutString(String base, String remove) {
                                                                        ...
                                                                        for (int i = 0; i < base.length(); i++) {
                                                                            ...
                                                                            if (base.substring(i).toLowerCase().startsWith(remove.toLowerCase())) {     // Compara subcadenas sin distinguir mayúsculas y minúsculas
                                                                                i = i + remove.length() - 1;                                            // Avanza el índice según la longitud de 'remove'
                                                                            } else {                                                     
                                                                                result = result +  base.charAt(i);                                      // Agrega el carácter actual a 'result'
                                                                            }
                                                                        }
                                                                        return result;
                                                                    }
...
public class codingbat2 {
    ...
    public static String palabra(String base, String remove) {
        String result = "";
    ...
    public static void main(String[] args) {
        ...
        String stremove = "e";
        String result = palabra(str, stremove);
...
//[CodingBat1: GHappy] Si hay xxggxx seguidas en un string = true, sino false
                                                            //sin los tests
...
//[CodingBat: GHappy] InteliJ Con los tests 
...
/*[CodingBat 2] CountTriple amb testos inclòs. Contar la cantidad de repeticiones que estan repetidas 3 veces seguidas.
...
//[CodingBat3]Si la cadena tiene un número, sumar todos los números. ej: aa1bc2d3 --> 6
